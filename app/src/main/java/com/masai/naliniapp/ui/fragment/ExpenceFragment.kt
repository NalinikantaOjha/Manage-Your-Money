...
import kotlinx.android.synthetic.main.fragment_expence.*


class ExpenceFragment : Fragment(),OnClick {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        recycleExpense.adapter = adapter2
        recycleExpense.layoutManager = LinearLayoutManager(requireContext())
